...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    ...
    label: "JavaScript",
    logoPath: "/javascript.png",
    jdoodleRuntime: { language: "nodejs", versionIndex: "7" }, // api that we're gonna be using
    monacoLanguage: "javascript",
    defaultCode: `// JavaScript Playground
const numbers = [1, 2, 3, 4, 5];
...
console.log('Sum of numbers:', sum);`,
  ...
  typescript: {
    ...
    label: "TypeScript",
    logoPath: "/typescript.png",
    jdoodleRuntime: { language: "typescript", versionIndex: "1" },
    monacoLanguage: "typescript",
    defaultCode: `// TypeScript Playground
interface NumberArray {
  numbers: number[];
...
console.log('Sum of numbers:', math.sum());`,
  ...
  python: {
    ...
    label: "Python",
    logoPath: "/python.png",
    jdoodleRuntime: { language: "python3", versionIndex: "6" },
    monacoLanguage: "python",
    defaultCode: `# Python Playground
numbers = [1, 2, 3, 4, 5]
...
print(f"Sum of numbers: {numbers_sum}")`,
  ...
  java: {
    ...
    label: "Java",
    logoPath: "/java.png",
    jdoodleRuntime: { language: "java", versionIndex: "6" },
    monacoLanguage: "java",
    defaultCode: `public class Main {
  public static void main(String[] args) {
      // Create array
  ...
  go: {
    ...
    label: "Go",
    logoPath: "/go.png",
    jdoodleRuntime: { language: "go", versionIndex: "6" },
    monacoLanguage: "go",
    defaultCode: `package main
...
func main() {
  ...
  rust: {
    ...
    label: "Rust",
    logoPath: "/rust.png",
    jdoodleRuntime: { language: "rust", versionIndex: "6" },
    monacoLanguage: "rust",
    defaultCode: `fn main() {
    // Create vector
    let numbers = vec![1, 2, 3, 4, 5];
  ...
  cpp: {
    ...
    label: "C++",
    logoPath: "/cpp.png",
    jdoodleRuntime: { language: "cpp17", versionIndex: "3" },
    monacoLanguage: "cpp",
    defaultCode: `#include <iostream>
#include <vector>
#include <algorithm>
...
int main() {
  ...
  csharp: {
    ...
    label: "C#",
    logoPath: "/csharp.png",
    jdoodleRuntime: { language: "csharp", versionIndex: "6" },
    monacoLanguage: "csharp",
    defaultCode: `using System;
using System.Linq;
...
class Program {
  ...
  ruby: {
    ...
    label: "Ruby",
    logoPath: "/ruby.png",
    jdoodleRuntime: { language: "ruby", versionIndex: "6" },
    monacoLanguage: "ruby",
    defaultCode: `# Create array
numbers = [1, 2, 3, 4, 5]
...
puts "Sum of numbers: #{sum}"`,
  ...
  swift: {
    ...
    label: "Swift",
    logoPath: "/swift.png",
    jdoodleRuntime: { language: "swift", versionIndex: "6" },
    monacoLanguage: "swift",
    defaultCode: `// Create array
let numbers = [1, 2, 3, 4, 5]
