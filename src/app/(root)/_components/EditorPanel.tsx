    ...
    <div className="relative">
      <div className="relative bg-[#12121a]/90 backdrop-blur rounded-xl border border-white/5 p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            {/* Font size slider */}
            <div className="flex items-center gap-3 px-3 py-3 bg-[#1e1e2e] rounded-lg ring-1 ring-white/5">
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg overflow-hidden bg-linear-to-r from-blue-500 to-blue-600 opacity-90 hover:opacity-100 transition-opacity"
            >
