  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        {/* Decoration */}
        <div
          className="absolute inset-0 bg-linear-to-r from-blue-500/10 to-purple-500/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
          aria-hidden="true"
        />
        ...
        <span className="text-gray-200 text-sm min-w-20 text-left group-hover:text-white transition-colors">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="max-h-70 overflow-y-auto overflow-x-hidden scrollbar-dark ">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="absolute inset-0 bg-linear-to-br from-blue-500/10 to-purple-500/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" />
                        <Image
                          src={lang.logoPath}
                          alt={`${lang.label} logo`}
                          width={24}
