        ...
        {filteredSnippets.length === 0 && (
          ...
          >
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-blue-500/10 to-purple-500/10 ring-1 ring-white/10 mb-6">
